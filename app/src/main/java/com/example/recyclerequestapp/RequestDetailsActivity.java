...
public class RequestDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authToken = SharedPrefManager.getInstance(this).getUser().getToken(); // ✅ Add "Bearer " prefix here
        ...
        Log.d("RequestDetailsActivity", "Received request ID: " + requestId);
    }

    private void fetchRequestDetails(int id) {
        requestService.getRequestById(authToken, id).enqueue(new Callback<Request>() {
            @Override
    ...
    private void displayRequestDetails(Request request) {
        ...
        String userLabel = request.getUsername() != null ? request.getUsername() : "ID: " + request.getUserId();
        tvRequestUser.setText("User: " + userLabel);

        String itemLabel = request.getItemName() != null ? request.getItemName() : "ID: " + request.getItemId();
        tvRequestItem.setText("Item: " + itemLabel);
        tvRequestAddress.setText("Address: " + (request.getAddress() != null ? request.getAddress() : "No Address"));
        tvRequestNotes.setText("Notes: " + (request.getNotes() != null ? request.getNotes() : "No Notes"));
    ...
    private void updateRequest() {
        ...
        requestService.updateRequestStatus(authToken, requestId, updateBody).enqueue(new Callback<ResponseBody>() {
            @Override
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    ...
                    handleApiError(response, "update request");
                }
            }
